...
# 错误代码：ep = entropy_perplexity(lm, data)
filepath='D:/ReviewHelpfulnessPrediction\ReviewSet/HTC_Z710t_review_2013.6.5.xlsx'
storepath='D:/ReviewHelpfulnessPrediction\ReviewDataFeature/HTC_EntPerFea.txt'

store_name_brand_attribute_features(word_by_word_review(filepath,1,4),filepath,1,4,storepath)
